        ...
        Cell: (d) => {
          ...
          return (
            <Grid component={Paper} container item xs={12} sx={{overflow: 'hidden'}}>
              <FullDialog open={open} setOpen={setOpen} modalContent={modalContent} title={d.row.original.collegeName} />
              ...
              <Grid container item xs={12} md={9} sx={{p:2, display: 'flex', justifyContent: 'center', alignItems: "center"}}>                
                <Grid item xs={12}>
                  <Typography variant="h6">{d.row.original.collegeName}</Typography>
                </Grid>
                <Grid item xs={6}>
                ...
                {d.row.original.totpendingvacancies !== 0 && (
                  <>
                    ...
                    <Grid item xs={12} md={6} size="small" sx={{mt: 2}}>
                      <Button variant="contained" color="error">Send Reminder</Button>
                    </Grid>
                  </>
                )}
              </Grid>
